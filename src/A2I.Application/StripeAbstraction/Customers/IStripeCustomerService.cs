...
public interface IStripeCustomerService
{
    ...
    Task<CustomerView> UpdateCustomerAsync(string stripeCustomerId, UpdateCustomerRequest req, CancellationToken ct = default);
    Task<bool> DeleteCustomerAsync(string stripeCustomerId, CancellationToken ct = default);

    Task<AttachPaymentMethodResult> AttachPaymentMethodAsync(string customerId, string paymentMethodId, CancellationToken ct = default);
