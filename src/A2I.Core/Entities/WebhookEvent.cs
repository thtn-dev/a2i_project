...
{
    [MaxLength(100)] public required string EventId { get; set; } // Stripe event_xxx

    [MaxLength(100)] public required string EventType { get; set; } // e.g., "invoice.paid"

    public DateTime ProcessedAt { get; set; }

    [MaxLength(20)] public string Status { get; set; } = "processed"; // processed | failed | retrying
